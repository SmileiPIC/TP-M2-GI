...
The longest simulation of the session runs approximately for 15 minutes with 1MPI process and 6 OpenMP threads. These parameters are already set in the submission script.

\item If you want to change the number of OpenMP threads in your simulation, change the corresponding line in the file \commandline{submission\_script.sh} (here 6 threads):\\
\commandline{export OMP\_NUM\_THREADS=6}

\item If you want to change the number of MPI process in your simulation, change the corresponding line in the file \commandline{submission\_script.sh} (here 1 process):\\
\commandline{\#SBATCH --ntasks=1}
